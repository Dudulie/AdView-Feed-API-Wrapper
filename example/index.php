        ...
        <div class="container">
            ...
            <div class="row">
                <div id="pagination" class="col-md-11">
                    <b>
                        <a class="btn btn-default" id="previous_page"
                           data-current-page="<?PHP echo $paginator->getCurrentPage(); ?>"
                           href="<?PHP echo $paginator->previousPageLink(); ?>">
                            Previous
                        </a>
                ...
                <?PHP echo $feed_api->getClicksTrackingScript(); ?>
            </div>
        </div>
    </body>
</html>
